...
<body>
    ...
    <section>
        ...
        <form id="newsletter-form" name="newsletter_form" method="post" action="form-handler.php">
			...
			<label for="html">Please select a subscription type.</label><br>
			<input type="radio" id="html" name="subscr_type" value="HTML">
			<label for="html">Normal</label><br>
			<input type="radio" id="html" name="subscr_type" value="HTML">
			<label for="html">Expert</label><br>
			<label for="html">Recieve special offers and latest updates?</label><br>
