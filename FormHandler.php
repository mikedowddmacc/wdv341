...
<title>Project - Contact Form With E-Mail</title>
</head>

<body>
<h1>WDV 341 Intro to PHP</h1>
<h2>Project - Contact Form With E-Mail</h2>
...
<?php
	...
	$msg = "Thank you for contacting us with your request, you should get a reply within 6-8 business days.";
...
Hello <?php echo $_POST["contact_name"];
<?php echo $_POST["contact_email"];
