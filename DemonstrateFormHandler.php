...
<title>UNIT 5-1 HTML Form Processor</title>
</head>

<body>
<h1>WDV 341 Intro to PHP</h1>
<h2>UNIT 5-1 HTML Form Processor</h2>
...
Dear <?php echo $_POST["first_name"]; ?><br>
Thank for you for your interest in DMACC.<br>
We have you listed as an <?php echo $_POST["academic_standing"]; ?> starting this fall.<br> 
You have declared <?php echo $_POST["selected_major"]; ?> as your major.<br> 
...
<?php echo $_POST["contact_info"]; ?><br>
<?php echo $_POST["contact_advisor"]; ?><br>
You have shared the following comments which we will review:
<?php echo $_POST["commentbox"]; ?>
</body>
</html>
